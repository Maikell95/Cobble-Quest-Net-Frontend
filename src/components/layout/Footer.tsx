      ...
      <div className="max-w-[1280px] mx-auto px-6 max-md:px-4">
        <div className="grid grid-cols-[1.5fr_1fr_1fr_1fr] gap-12 mb-12 max-md:grid-cols-2 max-md:gap-8 max-sm:grid-cols-1">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <a href={SERVER_CONFIG.discord} target="_blank" rel="noopener noreferrer" className="text-[#888] no-underline text-[0.9rem] hover:text-[#5865F2] transition-colors flex items-center gap-1.5">
              ...
              <a href="https://cobblemon.com" target="_blank" rel="noopener noreferrer" className="text-[#888] no-underline text-[0.9rem] hover:text-[#e74c3c] transition-colors flex items-center gap-1.5">
